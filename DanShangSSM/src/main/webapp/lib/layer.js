...
function lalert(msg) {
	layer.open({
		content: msg,
		shade: 0, //遮罩
		style: 'background-color:rgba(0,0,0,.5); font-size:16px;color:#fff; border:none;margin-top:120%;border-radius:28px;',
		time: 2
	});
}
//确认框
function lconfirm(msg, yes, no) {
